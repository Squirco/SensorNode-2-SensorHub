...
uint8_t BME280::id(void)
{
	return readRegister(BME280_CHIP_ID_REG);
}
...
uint16_t BME280::readHumidity( void )
{
...
uint16_t BME280::readTempC( void )
{
	...
	t_fine = var1 + var2;
	uint16_t temperature = (t_fine * 5 + 128) >> 8;
